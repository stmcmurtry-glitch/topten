...
export interface FeaturedList {
  ...
  /** 'YYYY-MM-DD' — date this list was first added to the app */
  addedAt?: string;
}
...
export const POPULAR_LISTS: PopularList[] = [
  ...
  { id: 'p-4',  title: 'Most Iconic Movie Villains',            category: 'Movies',  icon: 'film-outline',           color: CATEGORY_COLORS.Movies,  featuredId: 'f-58' },
...
export const FEATURED_LISTS: FeaturedList[] = [
  ...
  },
  {
    ...
    previewItems: [
      ...
      'Saquon Barkley — 2,005 yds (Eagles, 2024)',
  ...
  },
  {
    ...
    updatedAt: 'March 2026',
    statsSource: 'https://en.wikipedia.org/wiki/List_of_Stanley_Cup_champions',
    previewItems: [
  ...
  },
  {
    ...
    previewItems: [
      ...
      'Luka Dončić — 29.03 ppg*',
      'Joel Embiid — 27.63 ppg*',
      'Elgin Baylor — 27.36 ppg',
      'Kevin Durant — 27.16 ppg*',
      'Jerry West — 27.03 ppg',
      'LeBron James — 26.85 ppg*',
  ...
  },
  {
    ...
    color: CATEGORY_COLORS.Movies,
    author: 'TopX Editors',
    imageQuery: 'dark cinema dramatic villain shadow film noir',
  ...
  },
  {
    ...
    color: CATEGORY_COLORS.Music,
    author: 'TopX Editors',
    imageQuery: 'vinyl record music album collection retro',
    staticImageUrl: 'https://images.unsplash.com/photo-1614613535308-eb5fbd3d2c17?w=800&q=80',
    description: 'Ranked by total certified and estimated worldwide sales across all formats, per RIAA, BPI, and international industry bodies. Thriller outsells the #2 and #3 albums combined.',
    updatedAt: 'March 2026',
    statsSource: 'https://www.riaa.com/gold-platinum/',
    previewItems: [
      'Thriller — Michael Jackson (~66M copies)',
      'Back in Black — AC/DC (~50M copies)',
      'The Dark Side of the Moon — Pink Floyd (~45M copies)',
      'The Bodyguard Soundtrack — Whitney Houston (~44M copies)',
      "Their Greatest Hits (1971–1975) — Eagles (~44M copies)",
      'Bat Out of Hell — Meat Loaf (~43M copies)',
      'Come On Over — Shania Twain (~40M copies)',
      'Rumours — Fleetwood Mac (~40M copies)',
      'Led Zeppelin IV — Led Zeppelin (~37M copies)',
      'Falling Into You — Celine Dion (~32M copies)',
    ],
  },
  {
    id: 'f-60',
    addedAt: '2026-03-20',
    title: 'Highest-Grossing Movies — Adjusted for Inflation',
    category: 'Movies',
    icon: 'film-outline',
    color: CATEGORY_COLORS.Movies,
    author: 'TopX Editors',
    imageQuery: 'classic vintage cinema film reel movie theater retro',
    staticImageUrl: 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=800&q=80',
    description: 'Ranked by worldwide gross converted to 2024 dollars. Inflation-adjusted figures upend modern blockbuster assumptions — Gone with the Wind still leads by a landslide over Avatar and Avengers.',
    updatedAt: 'March 2026',
    statsSource: 'https://www.boxofficemojo.com/chart/top_lifetime_gross_adjusted/',
    previewItems: [
  ...
  },
  {
    id: 'f-61',
    addedAt: '2026-03-20',
    title: 'Most #1 Billboard Hot 100 Singles',
    category: 'Music',
    icon: 'musical-notes-outline',
    color: CATEGORY_COLORS.Music,
    author: 'TopX Editors',
    imageQuery: 'concert stage performance crowd music spotlight lights',
    staticImageUrl: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800&q=80',
    description: 'Ranked by total number of singles that reached #1 on the Billboard Hot 100 since the chart launched in 1958. Most people guess Mariah Carey — the answer will surprise you.',
    updatedAt: 'March 2026',
    statsSource: 'https://www.billboard.com/charts/hot-100/',
    previewItems: [
      'The Beatles — 20 #1 singles',
      'Mariah Carey — 19 #1 singles',
      'Rihanna — 14 #1 singles',
      'Michael Jackson — 13 #1 singles',
      'Madonna — 12 #1 singles',
      'Whitney Houston — 11 #1 singles',
      'Stevie Wonder — 10 #1 singles',
      'Drake — 9 #1 singles',
      'Bee Gees — 9 #1 singles',
      'Elton John — 9 #1 singles',
    ],
  },
  {
    id: 'f-62',
    ...
    color: CATEGORY_COLORS.Gaming,
    author: 'TopX Editors',
    imageQuery: 'video game controller gaming setup neon rgb',
    staticImageUrl: 'https://images.unsplash.com/photo-1493711662062-fa541adb3fc8?w=800&q=80',
    description: 'Ranked by total verified units sold across all platforms and editions. Minecraft outsells the #2 game by 53 million copies — and it started as a $10 indie project.',
    updatedAt: 'March 2026',
    statsSource: 'https://en.wikipedia.org/wiki/List_of_best-selling_video_games',
    previewItems: [
      'Minecraft — 238M+ copies',
      'Grand Theft Auto V — 185M+ copies',
      'Tetris (EA Mobile) — 100M+ copies',
      'Wii Sports — 82M copies',
      'PUBG: Battlegrounds — 75M+ copies',
      'Mario Kart 8 Deluxe — 62M+ copies',
      'Red Dead Redemption 2 — 61M+ copies',
      'The Elder Scrolls V: Skyrim — 60M+ copies',
      'Terraria — 44M+ copies',
      'Super Mario Bros. (NES) — 40M copies',
    ],
  },
  {
    id: 'f-64',
    addedAt: '2026-03-20',
    title: 'Most Olympic Gold Medals — Individual Athletes',
    category: 'Sports',
    icon: 'trophy-outline',
    color: CATEGORY_COLORS.Sports,
    author: 'TopX Editors',
    imageQuery: 'olympic gold medal athlete swimming podium ceremony',
    staticImageUrl: 'https://images.unsplash.com/photo-1551958219-acbc74be8b35?w=800&q=80',
    description: 'Ranked by total career Olympic gold medals won by individual athletes across all Summer and Winter Games. Michael Phelps won more golds than 161 countries have ever won in their entire history.',
    updatedAt: 'March 2026',
    statsSource: 'https://www.olympic.org/athletes',
    previewItems: [
  ...
  },
  {
    ...
    color: CATEGORY_COLORS.Books,
    author: 'TopX Editors',
    imageQuery: 'library books stacked shelves reading classic literature',
    staticImageUrl: 'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=800&q=80',
    description: 'Ranked by total estimated copies sold across all volumes. Goosebumps outselling The Lord of the Rings by a factor of 10 is the most underrated stat in all of publishing.',
    updatedAt: 'March 2026',
    statsSource: 'https://en.wikipedia.org/wiki/List_of_best-selling_book_series',
    previewItems: [
      'Harry Potter — J.K. Rowling (600M+ copies)',
      'Goosebumps — R.L. Stine (400M+ copies)',
      'Perry Mason — Erle Stanley Gardner (300M+ copies)',
      'Berenstain Bears — Stan & Jan Berenstain (260M+ copies)',
      'Diary of a Wimpy Kid — Jeff Kinney (250M+ copies)',
      'Choose Your Own Adventure — Various Authors (250M+ copies)',
      'The Baby-Sitters Club — Ann M. Martin (190M+ copies)',
      'Nancy Drew — Carolyn Keene (80M+ copies)',
      'The Hardy Boys — Franklin W. Dixon (70M+ copies)',
      'Animorphs — K.A. Applegate (35M+ copies)',
    ],
  },
  {
    id: 'f-66',
    addedAt: '2026-03-20',
    title: 'Most Michelin-Starred Restaurants by City',
    category: 'Food',
    icon: 'restaurant-outline',
    color: CATEGORY_COLORS.Food,
    author: 'TopX Editors',
    imageQuery: 'fine dining michelin star gourmet restaurant elegant plating',
    staticImageUrl: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800&q=80',
    description: 'Ranked by total Michelin-starred restaurants per city in the most recent Guide editions. Tokyo holds nearly double the stars of Paris — a fact that stuns most food lovers.',
    updatedAt: 'March 2026',
    statsSource: 'https://guide.michelin.com/en/restaurants',
    previewItems: [
      'Tokyo, Japan — 230+ starred restaurants',
      'Paris, France — 134 starred restaurants',
      'Kyoto, Japan — 94 starred restaurants',
      'Osaka, Japan — 93 starred restaurants',
      'London, UK — 83 starred restaurants',
      'Hong Kong — 72 starred restaurants',
      'New York City, USA — 70 starred restaurants',
      'San Francisco Bay Area, USA — 55 starred restaurants',
      'Shanghai, China — 40 starred restaurants',
      'Chicago, USA — 25 starred restaurants',
    ],
  },
  {
    id: 'f-67',
    ...
    color: CATEGORY_COLORS.Arts,
    author: 'TopX Editors',
    imageQuery: 'broadway theater stage curtain lights performance dramatic',
    staticImageUrl: 'https://images.unsplash.com/photo-1507676184212-d03ab07a01bf?w=800&q=80',
    description: 'Ranked by total number of performances in the longest continuous Broadway run. Shows still running are marked with an asterisk. The Phantom of the Opera ran for 35 years.',
    updatedAt: 'March 2026',
    statsSource: 'https://en.wikipedia.org/wiki/List_of_longest-running_Broadway_shows',
    previewItems: [
  ...
  },
  {
    id: 'f-68',
    addedAt: '2026-03-20',
    title: 'Most Expensive Paintings Ever Sold',
    category: 'Arts',
    icon: 'color-palette-outline',
    color: CATEGORY_COLORS.Arts,
    author: 'TopX Editors',
    imageQuery: 'art museum painting gallery masterpiece canvas exhibition',
    staticImageUrl: 'https://images.unsplash.com/photo-1580060839134-75a5edca2e99?w=800&q=80',
    description: "Ranked by verified sale price at auction or confirmed private transaction. Salvator Mundi's $450M hammer price is nearly double the #2 spot — the most jaw-dropping art market moment ever recorded.",
    updatedAt: 'March 2026',
    statsSource: 'https://en.wikipedia.org/wiki/List_of_most_expensive_paintings',
    previewItems: [
